...
public class AudioPlayer implements AudioPlayerInterface {
	...
	private MediaPlayer mediaPlayerBang; //SFX
	...
	@Override
	public String getLevelUpSoundFilePath() {
		return LEVEL_UP_SFX_FILE;
	}

	@Override
	public String getSharkMusicFilePath() {
		return SHARK_MUSIC_FILE;
	}
	...
	@Override
	public void fadeOutToSharkMusic() {
		if(this.playingBackgroundMusic) {
	...
	public void playSharkMusic() {
		if (!this.playingBackgroundMusic) {
			this.playingBackgroundMusic = true;
			this.mediaPlayer = new MediaPlayer(loadAudioFile(getSharkMusicFilePath()));
			this.mediaPlayer.setAutoPlay(true);
			// Loop for the main music sound:
			this.mediaPlayer.setOnEndOfMedia(() -> AudioPlayer.this.mediaPlayer.seek(Duration.ZERO));
			this.mediaPlayer.play();
    ...
    public void playCrashSound() {
		...
		if(mediaPlayerBang!= null) {
			mediaPlayerBang.stop();
		}
		mediaPlayerBang = new MediaPlayer(loadAudioFile(getCrashSoundFilePath()));
	...
	public void playLevelUpSound() {
		...
		mediaPlayerBang = new MediaPlayer(loadAudioFile(getLevelUpSoundFilePath()));
		mediaPlayerBang.play();
	}
